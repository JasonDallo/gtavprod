skins = {
	...
	local cords = {
	{ 88.291,-1391.929, 29.200 },
	{ 718.985, -158.059, 36.996 },
	{ -151.204,-306.837, 38.724 },
	{ 414.646, -807.452, 29.338 },
	{ -815.193, -1083.333, 11.022 },
	{ -1208.098, -782.020, 17.163 },
	{ -1457.954, -229.426, 49.185 },
	{ -2.777, 6518.491, 31.533 },
	{ 1681.586, 4820.133, 42.046 },
	{ 130.216, -202.940, 54.505 },
	{ 618.701, 2740.564, 41.905 },
	{ 1199.169, 2694.895, 37.866 },
	{ -3164.172, 1063.927, 20.674 },
	{ -1091.373, 2702.356, 19.422 }
	...
	while true do
		Citizen.Wait(0)
		 for i,v in pairs(cords) do
			DrawMarker(1,v[1],v[2],v[3],0,0,0,0,0,0,4.001,4.0001,0.5001,0,155,255,200,0,0,0,0)
		 	if GetDistanceBetweenCoords(v[1],v[2],v[3],GetEntityCoords(LocalPed())) < 5  then
		 		InZone = true
		 	end
		 end
		if IsControlJustPressed(1, 289) and InZone == true then -- INPUT_CELLPHONE_DOWN
			InitMenu()                       
