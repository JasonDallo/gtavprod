...
name = "main",
buttons = {
{name = "Pistol 50", description = "", price = 0, model="WEAPON_Pistol50"},
{name = "SMG", description = "", price = 0, model="WEAPON_MicroSMG"},
{name = "Carabine", description = "", price = 0, model="WEAPON_CarbineRifle"},
{name = "Tazer", description = "", price = 0, model="WEAPON_StunGun"},
{name = "Night Stick", description = "", price = 0, model="NIGHTSTICK"},
}
},
}
}
			...
			while #garage_blips > 0 do
				...
				for i,b in ipairs(garage_blips) do
					...
					if GetDistanceBetweenCoords(b.pos.entering[1],b.pos.entering[2],b.pos.entering[3],GetEntityCoords(LocalPed())) < 2 then
						drawTxt('Appuie sur ~g~Entrée~s~ ouvrir le menu des armes',0,1,0.5,0.8,0.6,255,255,255,255)
						currentlocation = b
						inr = true
